        ...
        <v-container>
            <div style="margin-top: 30px">
                <span>
                    ...
                    <span class="ml-2" style="font-size: 15x;">{{ website.job.titleSub }}</span>
                </span>
                <h2 :style="website.color.tealMain">{{ website.job.titleMain }}</h2>
            </div>

            <div class="mt-10">
                <v-tabs :color="website.color.tealMain.color" right>
                    <v-tab>Tất cả mới nhất</v-tab>
                    <v-tab>Việc làm HOT</v-tab>
                    <v-tab>Xem nhiều nhất</v-tab>

                    <v-tab-item v-for="n in 3" :key="n" class="mt-5">

                        <v-row>
                            <v-col cols="12" sm="6" md="4" lg="3" v-for="job in jobs" :key="job._id">
                                    ...
                                    <div class="p-4">
                                        <v-row>
                                            <v-col cols="12">
                                                ...
                                                <h6 class="mt-5">{{ job.name.length > 50 ? `${job.name.substring(0,
                                                        50)}...` :
                                                ...
                                                <div>{{ job.jobLocation.length > 30 ? `${job.jobLocation.substring(0,
                                                        30)}...` :
                                                        `${job.jobLocation}____________`
