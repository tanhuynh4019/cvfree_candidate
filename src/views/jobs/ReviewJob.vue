<template>
    <div v-resize="onResize">
        ...
        <div v-if="!isLoading">
            <div class="review-job" :style="`background-image: url('${job.idCompany.srcBanner}')`">
                    ...
                    <v-row>
                        <v-col cols="12" md="8">
                            <div :class="!isMobile ? '' : 'text-center'">
                                ...
                                <h5 class="font-weight-bold mt-3">{{ job.name }} ({{ job.vacancies }}) 
                                    <v-tooltip bottom
                                        :color="website.color.tealMain.color" v-if="job.idCompany.isBrowser">
                                        ...
                                        <span>
                                            ...
                                            <div>
                                                <i class="mdi mdi-check-circle"></i> Đã xác thực email tên miền công ty
                                            </div>
                                             <div>
                                                <i class="mdi mdi-check-circle"></i> Đã xác thực số điện thoại
                                            </div>
                                             <div>
                                                <i class="mdi mdi-check-circle"></i> Đã được duyệt giấy phép kinh doanh
                                            </div>
                                        </span>
                                    </v-tooltip>
                                    <v-tooltip bottom
                                        :color="website.color.tealMain.color" v-if="job.isBrowser">
                                        <template v-slot:activator="{ on, attrs }">
                                            <v-btn color="#C5E1A5" dark v-bind="attrs" v-on="on" icon>
                                        ...
                                        <span>
                                            ...
                                            <div>
                                             ...
                                             <div>
                                                <i class="mdi mdi-check-circle"></i> Không có báo cáo từ ứng viên
                                            </div>
                                             <div>
                                                <i class="mdi mdi-check-circle"></i> Là tin tuyển dụng đáng tin cậy
                                            </div>
                                        </span>
                                    </v-tooltip>
                                </h5>
                        ...
                        <v-col cols="12" md="4">
                            <div>
                                <div :class="!isMobile ? 'float-end' : 'text-center'" style="margin-top: 10%">
                                    <v-btn class="w-100" :color="website.color.yellowSubColor.color" depressed x-large>
                                        Ứng
                                        tuyển ngay
                                    </v-btn>
            ...
            <v-footer app color="white" style="border: 1px solid #BDBDBD !important" height="120" inset
                v-if="offset_top > 200">
                <v-container>
                    <v-row>
                        <v-col cols="12" sm="6">
                            <div class="mt-3" v-if="!isMobile">
                                <h6 class="font-weight-bold">{{ job.name }} ({{ job.vacancies }})</h6>
                                <i>Hết hạn: {{ formatDate(job.deadline) }}</i>
                            </div>
                        </v-col>
                        <v-col cols="12" sm="6">
                            <div :class="!isMobile ? 'float-end' : ''">
                                <v-btn class="w-100" :color="website.color.tealMain.color" dark depressed x-large>Ứng
                                    tuyển
                                    ngay
                                </v-btn>
                            </div>
            ...
            <v-app-bar app color="white" height="55"
                :style="`${isMarginTop ? 'margin-top: 120px' : 'margin-top: 70px'}; box-shadow: none; border: 1px solid #BDBDBD !important`"
                ...
                <v-container>
                    <v-tabs v-model="tabModel" :color="website.color.tealMain.color" show-arrows>
                        ...
                        <v-tab @click="changeLinkTab('company')" @click.native="scrollToTop()">
                            <v-icon left>
                                mdi-office-building-outline
                            </v-icon>
                            Thông tin công ty
                        </v-tab>
                        <v-tab @click="changeLinkTab('related-jobs')" @click.native="scrollToTop()">
                            <v-icon left>
                                mdi-briefcase-plus
                            </v-icon>
                            Việc làm liên quan
                        ...
                        <v-col cols="12" md="8">
                            ...
                            <v-tabs-items v-model="tabModel">
                                <v-tab-item>
                                    ...
                                    <p>Ứng viên nộp hồ sơ trực tuyến bằng cách bấm <b
                                            :style="website.color.tealMain">Ứng
                                            tuyển
                                            ngay</b> dưới đây.</p>
                                    <v-btn :color="website.color.tealMain.color" dark depressed x-large>
                                        Ứng tuyển ngay
                                    </v-btn>
                                </v-tab-item>
                                <v-tab-item>
                                        ...
                                        <v-card style="box-shadow: none; border-radius: 10px" class="border text-start">
                                            <div class="p-4">
                                                ...
                                                <v-list style="margin-left: -20px;">
                                                    <v-list-item>
                                                        <v-list-item-content>
                                                            <v-list-item-title><b>Quy mô công ty</b>
                                                            </v-list-item-title>
                                                        </v-list-item-content>
                                                        <v-list-item-content>
                                                            <v-list-item-subtitle class="text-end">
                                                                <v-chip outlined :color="website.color.tealMain.color"
                                                                    label>
                                                ...
                                                <v-btn :color="website.color.tealMain.color" depressed dark>Xem trang cá
                                                    nhân công ty</v-btn>
                                            </div>
                                        </v-card>
                                    </v-card>
                                    ...
                                    <v-card flat>
                                        <v-card-text>
                                            <p>
                                                ...
                                                a
                                                accumsan
                                                nisi mauris ac eros. In dui magna, posuere eget, vestibulum et, tempor
                                                auctor,
                                                justo.
                                            </p>
                                            ...
                                            <p class="mb-0">
                                                ...
                                                sapien
                                                ipsum, porta a, auctor quis, euismod ut, mi. Donec quam felis, ultricies
                                                nec,
                                                pellentesque eu, pretium quis, sem. Nam at tortor in tellus interdum
                                                sagittis.
                                            </p>
                                        </v-card-text>
                                    </v-card>
                        ...
                        <v-col cols="12" md="4">
                            <v-card style="box-shadow: none;" class="border">
                                <div class="p-2">
                                    <v-list>
                                        <v-list-item>
                                            <v-list-item-avatar>
                                                <v-img src="../../images/Icon/salary.gif">
                                                </v-img>
                                            </v-list-item-avatar>
                                            ...
                                            <v-list-item-content>
                                                ...
                                                <v-list-item-subtitle>
                                                    {{ job.numberOfRecruitments == 0
                                                            ? 'Không giới hạn' : `Cần ${job.numberOfRecruitments} người`
                                                    }}</v-list-item-subtitle>
                                            </v-list-item-content>
                                        </v-list-item>
                                        <v-divider></v-divider>
                                        <v-list-item>
                                            <v-list-item-avatar>
                                                <v-img src="../../images/Icon/level.gif">
                                                </v-img>
                                            </v-list-item-avatar>
                                            ...
                                            <v-list-item-content>
                                                ...
                                                <v-list-item-subtitle>{{ job.level }}</v-list-item-subtitle>
                                            </v-list-item-content>
                                        </v-list-item>
                                        <v-divider></v-divider>
                                        <v-list-item>
                                            ...
                                            <v-list-item-content>
                                                ...
                                                <v-list-item-subtitle>{{ job.workingForm }}</v-list-item-subtitle>
                                            </v-list-item-content>
                                        </v-list-item>
                                        <v-divider></v-divider>
                                        <v-list-item>
                                            <v-list-item-avatar>
                                                <v-img src="../../images/Icon/gender.png">
                                                </v-img>
                                            </v-list-item-avatar>
                                            ...
                                            <v-list-item-content>
                                                ...
                                                <v-list-item-subtitle>{{ job.gender }}</v-list-item-subtitle>
                                            </v-list-item-content>
                                        </v-list-item>
                                        <v-divider></v-divider>
                                        <v-list-item>
                                            <v-list-item-avatar>
                                                <v-img src="../../images/Icon/exp.png">
                                                </v-img>
                                            </v-list-item-avatar>
                                            ...
                                            <v-list-item-content>
                                                ...
                                                <v-list-item-subtitle>{{ job.exp }}</v-list-item-subtitle>
                                            </v-list-item-content>
                                        </v-list-item>
                                    </v-list>
                                </div>
                            ...
                            <div class="mt-5">
                                <div v-if="job.sideProfessions.length != 0">
                                    ...
                                    <v-chip dark label :color="website.color.tealMain.color"
                                        :class="i == 0 ? 'mt-1' : 'ml-1 mt-1'"
                                        v-for="(sideProfession, i) in job.sideProfessions" :key="sideProfession">
                            ...
                            <div class="mt-5">
                                <div v-if="job.skills.length != 0 && job.skills[0] != ''">
                                    ...
                                    <h4>Kỹ năng</h4>
                                    <v-chip dark label :color="website.color.tealMain.color"
                                        :class="i == 0 ? '' : 'ml-1'" v-for="(skill, i) in job.skills" :key="skill">{{
                                                skill
                                        }}</v-chip>
                                </div>
                            </div>
