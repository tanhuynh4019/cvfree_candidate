    ...
    <div v-resize="onResize">
                ...
                <v-row>
                    <v-col cols="12" md="8">
                        <div :class="!isMobile ? '' : 'text-center'">
                            ...
                            <h5 class="font-weight-bold mt-3">{{ job.name }} ({{ job.vacancies }})</h5>
                            <b>
                    ...
                    <v-col cols="12" md="4">
                        <div>
                            <div :class="!isMobile ? 'float-end' : 'text-center'" style="margin-top: 10%">
                                <v-btn class="w-100" :color="website.color.yellowSubColor.color" depressed x-large>Ứng
                                    tuyển ngay
                                </v-btn>
                                <div class="mt-5" style="margin-left: -25px;">
                                    <i>Hết hạn: {{ formatDate(job.deadline) }}</i>
                                    <center>
                                        <v-btn text dark><i class="mdi mdi-heart-multiple-outline"></i>Lưu</v-btn>
                                        <v-btn text dark><i class="mdi mdi-share-variant-outline"></i>Chia sẻ</v-btn>
        ...
        <v-footer app color="white" style="border: 1px solid #BDBDBD !important" height="120" inset
            ...
            <v-container>
                <v-row>
                    <v-col cols="6">
                        <h6 class="font-weight-bold mt-3">{{ job.name }} ({{ job.vacancies }})</h6>
                        <div class="mt-1" v-if="!isMobile">
                            <i>Hết hạn: {{ formatDate(job.deadline) }}</i>
                        </div>
                    </v-col>
                    <v-col cols="6">
                        <div class="float-end">
                            <v-btn class="w-100" :color="website.color.tealMain.color" dark depressed x-large>Ứng tuyển
                                ngay
                            </v-btn>
                    ...
                    <v-col cols="12" md="8">
                        ...
                        <v-tabs-items v-model="tabModel">
                            <v-tab-item>
                                ...
                                <p>Ứng viên nộp hồ sơ trực tuyến bằng cách bấm <b :style="website.color.tealMain">Ứng
                                        tuyển
                                        ngay</b> dưới đây.</p>
                    ...
                    <v-col cols="12" md="4">
                                ...
                                <v-list>
                                    ...
                                    <v-list-item>
                                        ...
                                        <v-list-item-content>
                                            ...
                                            <v-list-item-subtitle>{{ job.numberOfRecruitments == 0 ? 'Không giới hạn' :
                        ...
                        <div class="mt-5">
                            <div v-if="job.skills.length != 0 && job.skills[0] != ''">
                                ...
                                <h4>Kỹ năng</h4>
                                <v-chip dark label :color="website.color.tealMain.color" :class="i == 0 ? '' : 'ml-1'"
                                    v-for="(skill, i) in job.skills" :key="skill">{{ skill }}</v-chip>
                            </div>
                        </div>
                    </v-col>
                </v-row>
